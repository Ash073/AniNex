...
// ══════════════════════════════════════════════════════════
export const CURRENT_VERSION = '1.1.0 (Fix 1)';
const STORAGE_KEY = `@animex_update_dismissed_v1.1.0_f1`;
...
export const UPDATE_NOTES: UpdateNote[] = [
    {
        ...
        description: 'Fixed a critical issue where tapping DM or Server notifications did not take you to the correct screen. Everything is now deep-linked!',
        tag: 'Fixed',
        tagColor: '#3b82f6',
    },
    {
        ...
        description: 'Enabled direct updates! Future improvements will download automatically when you open the app, no re-installation required.',
        tag: 'New',
        tagColor: '#22c55e',
    },
    {
        ...
        description: 'Improved push token registration and logout security. Your notifications are now strictly tied to your active session.',
        tag: 'Improved',
        tagColor: '#10b981',
    },
    {
        ...
        description: 'Our Aura Analysis system is now more stable. Discover your character archetype, rank, and power level with 99% accuracy.',
        tag: 'Main Feature',
        tagColor: '#a855f7',
    },
];
